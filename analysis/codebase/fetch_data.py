...
class FetchData:
  ...
  def fetch_data_from_file(self):
    ...
    datafile = pandas.read_csv("analysis\python_codebase\datasets\dataset.csv", usecols=column_list)
...
# # main function for testing the class-methods
# if __name__ == '__main__':
#   FetchDataObject = FetchData(True)
#   FetchDataObject.fetch_data_from_file()